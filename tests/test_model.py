"""Unit tests for the Iris classifier model."""
import sys
import os
import pytest
import numpy as np
...
def test_data_format():
    ...
    assert all(isinstance(label, (np.int32, np.int64, int)) for label in y_train)
...
def test_prediction_range():
    ...
    # Predictions should be 0, 1, or 2 (three iris classes)
